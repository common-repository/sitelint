          ...
          <div class="box-secondary">
            ...
            <div class="row mb-4">
              <div class="col-md-9">
                ...
                <pre class="ws-break-line"><?php echo esc_html(sitelint_get_workspace_name($options['workspace'], $options['workspaces'])) ?></pre>
              </div>
            ...
            <div class="row">
              <div class="col-md-9">
                <div class="site-report__workspace-item mb-2"><small><?php echo __('Selected Site', 'sitelint') ?>:</small></div>
                <pre class="ws-break-line"><?php echo empty($options['site']) ? __('No sites available', 'sitelint') : esc_html($options['site']) ?></pre>
              </div>
              <div class="col-md-3 d-flex align-items-center">
