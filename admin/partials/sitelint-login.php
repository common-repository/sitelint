...
<div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
  ...
  <div class="main-form box-tab-content">
    ...
    <p class="text-center mb-4"><?php echo __('Don\'t have an account?', 'sitelint') ?> <a href="https://platform.sitelint.com/signup" target="_blank"><?php echo __('Sign up', 'sitelint') ?></a> <?php echo __('now', 'sitelint') ?>.</p>
